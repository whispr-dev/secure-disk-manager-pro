...
## v0.2.0 Python Demo Archive Expansion

See `PYTHON_DEMO_FUNCTION_MAP.md` for the complete mapping from the attached `python_library_demos_sm0l.tar.gz` scripts into the new Rust module `src/python_ops.rs`.
